...
subgraph "输出目录"
OUTPUT[output/<视频名称>/]
VIDEOCLIP[video_clip_result/]
FRAMES[video_clip_result/frame_*.jpg]
AUDIO[video_clip_result/audio.wav]
TRANSCRIPT[video_clip_result/transcript.txt]
ANALYSIS[analyse_result/analysis.json]
DESIGN[analyse_result/landing_page_design.md]
HTML[analyse_result/landing_page_design.html]
DESIGNREFER[design_refer/pageN/]
end
end
RUN --> TRANS
RUN --> ANALYZE
...
- **关键帧提取**: 从视频前30秒按每秒一帧提取0~29秒关键帧
- **音频提取**: 提取视频前30秒的音频用于转写分析
...
Runner->>FFmpeg : 提取前30秒关键帧 (0~29s，每秒一帧)
