...
subgraph "资产文件"
ASSETS[assets/]
EXAMPLES[assets/categories/{category}/examples/]
end
subgraph "输出目录"
OUTPUT[output/]
...
- **关键帧处理**：自动截取视频前30秒的关键帧（0s, 3s, 6s, 9s, 12s）
...
- [generate.py:464-477](file://generate.py#L464-L477)
- [generate.py:488-611](file://generate.py#L488-L611)
- [assets/categories/{category}/generate_prompt.md:58-63](file://assets/categories/{category}/generate_prompt.md#L58-L63)
...
**章节来源**
- [assets/categories/{category}/generate_prompt.md:112-156](file://assets/categories/{category}/generate_prompt.md#L112-L156)
- [generate.py:619-664](file://generate.py#L619-L664)
- [generate.py:667-723](file://generate.py#L667-L723)
...
**图表来源**
- [assets/categories/{category}/generate_prompt.md:58-62](file://assets/categories/{category}/generate_prompt.md#L58-L62)
...
**图表来源**
- [assets/categories/{category}/generate_prompt.md:22-95](file://assets/categories/{category}/generate_prompt.md#L22-L95)

**章节来源**
- [assets/categories/{category}/generate_prompt.md:7-11](file://assets/categories/{category}/generate_prompt.md#L7-L11)
- [assets/categories/{category}/generate_prompt.md:58-62](file://assets/categories/{category}/generate_prompt.md#L58-L62)
- [assets/categories/{category}/generate_prompt.md:22-95](file://assets/categories/{category}/generate_prompt.md#L22-L95)
...
MARKDOWN
ASSETS[assets/]
TEACHER_FACE_REF_1[assets/categories/{category}/teacher_face_ref_1.jpg]
TEACHER_FACE_REF_2[assets/categories/{category}/teacher_face_ref_2.jpg]
...
REQUESTS
PIL
BRAND_LOGO[assets/categories/{category}/brand_logo.png]
...
| 三视图缺失 | 生成警告：缺少老师脸部三视图 | 确保assets/categories/{category}/teacher_face_ref_1.jpg和assets/categories/{category}/teacher_face_ref_2.jpg存在 |
